...
import joeq.Compiler.Analysis.Primitive.PrimitiveMethodSummary.ParamNode;
...
public class PrimitivePA {
    ...
    BDDVarSet V1set, V2set, H1set, H2set, T1set, T2set, Fset, Mset, Nset, Iset, I2set, Zset;
    ...
    void analyzeIE(){
        ...
        for(Iterator iter = Imap.iterator(); iter.hasNext();){
            ...
            if(t.isZero()){
                ...
                jq_Type type = n.getDeclaredType();
    ...
    ConcreteTypeNode addPlaceholderObject(jq_Type type, int depth, ProgramLocation.PlaceholderParameterProgramLocation location) {
    ...
    public void visitMethod(jq_Method m) {
        ...
        PrimitivePAMethodSummary s = new PrimitivePAMethodSummary(this, m);
    ...
    public void addAllMethods() {
        ...
        for (Iterator i = newMethodSummaries.entrySet().iterator(); i.hasNext(); ) {
            ...
            PrimitivePAMethodSummary s = (PrimitivePAMethodSummary) e.getValue();
    ...
    void addToVT(int V_i, jq_Type type) {
        BDD bdd1 = V1.ithVar(V_i);
    ...
    void addToHT(int H_i, jq_Type type) {
    ...
    jq_Method javaLangObject_fakeclone = jq_FakeInstanceMethod.fakeMethod(object_class, 
        fakeCloneName, "()Ljava/lang/Object;");
    ...
    public void buildTypes() {
        ...
        for (int T_i = 0; T_i < Tsize; ++T_i) {
            jq_Type t = (jq_Type) Tmap.get(T_i);
            BDD T_bdd = T2.ithVar(T_i);
            ...
            for (int N_i = start; N_i < Nsize; ++N_i) {
                ...
                if (n.isStatic()) {
                    ...
                    if (t == null || t == jq_NullType.NULL_TYPE || !t.isSubtypeOf(n.getDeclaringClass())) {
                        continue;
                    }
                    m = ((jq_Reference)t).getVirtualMethod(n.getNameAndDesc());
                }
    ...
    public void addFinalizer(jq_Class c, Node h) {
        ...
        if (m != null && m.getBytecode() != null) {
            ...
            Node p = PrimitiveMethodSummary.getSummary(m).getParamNode(0);
            int H_i = Hmap.get(h);
            addToVP(p, H_i);
        }
    }
...
// 13%
    ...
    public boolean bindReflection(){
        ...
        for(Iterator iter = t9.iterator(H1set.union(I2set)); iter.hasNext();){
            ...
            PrimitiveMethodSummary.ConcreteTypeNode n = (ConcreteTypeNode) node;
            String stringConst = (String) PrimitiveMethodSummary.stringNodes2Values.get(n);
            if(stringConst == null){
...
//                System.out.println("t2: " + t2.toStringWithDomains(TS));
                for(Iterator iter2 = t2.iterator(H1set); iter2.hasNext();){
                    ...
                    Node n = (Node) Hmap.get(h_i);
                    if(n instanceof PrimitiveMethodSummary.ConcreteTypeNode){
...
//                this.ocg.addEdge(null, (Node) null, (jq_Reference)con.getDeclaredType());
//            }
//        }
    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        PrimitivePA dis = new PrimitivePA();
        dis.cg = null;
    ...
    public void dumpCallGraph() throws IOException {
        ...
        CallGraph callgraph = new CachedCallGraph(new PrimitivePACallGraph(this));
    ...
    public static PrimitivePA loadResults(String bddfactory, String loaddir, String loadfilename) throws IOException {
                ...
                if (n instanceof ConcreteTypeNode ||
                    ...
                    if (type != null && type != jq_NullType.NULL_TYPE) {
                        ...
                        if (type.isSubtypeOf(jlt) ||
                            ...
                            jq_Method rm = ((jq_Class)type).getVirtualMethod(run_method);
...
//                        }
                ...
                jq_Type r = (jq_Type) n.getDeclaredType();
                classes.get(r);
            }
        ...
        if (ADD_SUPERTYPES) {
            for (int i = 0; i < classes.size(); ++i) {
                jq_Type t1 = (jq_Type) classes.get(i);
                if (t1 == null || t1 instanceof jq_NullType || !(t1 instanceof jq_Reference)) continue;
                t1.prepare();
                jq_Reference t0 = (jq_Reference) t1;
                jq_Reference t2 = t0.getDirectPrimarySupertype();
                if (t2 != null) {
        ...
        if (updateBits) {
            ...
            H_BITS = BigInteger.valueOf(heaps).bitLength()+2;
    ...
    public class HeapPathSelector implements Selector {
        ...
        public boolean isImportant(Object p, Object o, BigInteger num) {
            ...
            if (MATCH_FACTORY) {
                ...
                PrimitiveMethodSummary ms = PrimitiveMethodSummary.getSummary(CodeCache.getCode(m));
...
//                    System.out.println("register " + j + " is null");
 ...
 //               System.out.println("register is "+j);
    ...
    private void dumpSSA() throws IOException {
        ...
        //System.out.println("hQuad: "+(long) sync.satCount(H1.set().union(quad.set()))+" relations, "+hQuad.nodeCount()+" nodes");
